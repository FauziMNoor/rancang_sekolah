export const timelineData = [
  {
    ...
    description: 'Prioritas utama adalah penguasaan perangkat dasar (Bahasa Arab dan Logika Coding). Santri belum dituntut membuat maha karya kompleks, melainkan membangun kebiasaan. Segala hal yang menjadi "alat utama" untuk kelas berikutnya secara intens diakuisisi (di-instal) di sini dari tahap paling dasar.',
    semesters: [
      {
        sem: 1,
        title: 'Penguasaan Alat Dasar',
        items: [
          { emoji: '📖', text: 'Tahajji (Qaidah Samiriyyah) — Pelafalan Huruf Arab' },
          { emoji: '🗣️', text: 'Bahasa Arab Intensif (ABY 1-3)' },
          { emoji: '📜', text: 'Hadits Arba\'in 1-8' },
          { emoji: '💻', text: 'IT Dasar (HTML, CSS, JS)' },
          { emoji: '🧠', text: 'Agile Mindset Level 1' }
        ]
      },
      {
        sem: 2,
        title: 'Mulazamah & Backend',
        items: [
          { emoji: '🕌', text: 'Aqidatuna (Mulazamah Intensif)' },
          { emoji: '⚖️', text: 'Fathul \'Ali (Mulazamah)' },
          { emoji: '📗', text: 'Nabiyuna — Sirah Nabi ﷺ' },
          { emoji: '🔠', text: 'Jurumiyah — Nahwu Dasar' },
    ...
    semesters: [
      {
        ...
        items: [
          { emoji: '🌍', text: 'Bahasa Inggris Intensif (22 Minggu)' },
          { emoji: '💻', text: 'IT — Website Sekolah Dinamis (React.js)' },
          { emoji: '📜', text: 'Hadits Arba\'in 17-24' },
      ...
      },
      {
        ...
        items: [
          ...
          { emoji: '📜', text: 'Hadits Arba\'in 25-32' },
          { emoji: '🧠', text: 'Agile Mindset Level 2 (Lanjutan)' }
        ]
      }
    ],
    outputs: [
